...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/user/testUser", "/product/filter", "/worker/filter", "/receiptOrderOfGoods/filter").hasAuthority(Permission.USER_READ.getPermission())
                .antMatchers("/user/testAdmin", "/product/**","/worker/**", "/receiptOrderOfGoods/**").hasAuthority(Permission.USER_WRITE.getPermission())
